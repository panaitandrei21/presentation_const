...
export default function Home() {
  return (
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-100 to-blue-100">
        ...
        {/* Hero */}
        <section
            className="flex flex-col md:flex-row items-center justify-center flex-1 text-center md:text-left py-12 px-6 gap-8">
          <div className="flex-1">
            <h1 className="text-4xl md:text-5xl font-extrabold text-blue-900 mb-4">
              Specialiști în benzi rigips și vopsitorie interioară
            </h1>
            <p className="text-lg text-gray-800 mb-6">
              Echipa <b>ConstructFix</b> e formată din profesioniști dedicați care aduc atenție la detalii și finisaje
              impecabile, fie că este vorba de apartamente, case sau spații de birouri.
            </p>
            <a href="#contact"
        ...
        <section id="despre" className="py-10 px-4 bg-white shadow-inner">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-800">
              Suntem specializați în <b>finisaje rigips</b> și <b>vopsitorii interioare</b>. Punem accent pe lucrul
              curat, respectarea termenelor și comunicare deschisă cu fiecare client.
              <br/>
        ...
        <section id="contact" className="py-12 px-4 bg-white">
          <div className="max-w-xl mx-auto">
            ...
            <form className="bg-blue-50 rounded-xl shadow p-6 flex flex-col gap-4">
              ...
              <button type="submit"
                      className="bg-blue-800 text-white px-4 py-2 rounded-xl font-semibold hover:bg-blue-900 transition">
                Trimite mesaj
              </button>
            </form>
